...
| File | Purpose |
|---|---|
| `learner/mp2_rag.py` | Main rag pipeline implemetatiom|
...
| `learner/data/learner_questions.jsonl` |  3 new questions added by me |
| `learner/requirements.txt` | Python dependencies |
| `learner/mp2_validation.txt` | Output results of validate |
| `learner/mp2_reflection.txt` | One pager reflection of overall experience working on the assignment |
